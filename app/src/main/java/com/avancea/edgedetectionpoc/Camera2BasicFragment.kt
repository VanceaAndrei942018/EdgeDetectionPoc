...
class Camera2BasicFragment : Fragment(),
    ...
    private val mSurfaceTextureListener: SurfaceTextureListener = object : SurfaceTextureListener {
        ...
        override fun onSurfaceTextureUpdated(texture: SurfaceTexture) {
            ...
            overlay!!.processFrame(frame)
        }
    }
    private var overlay: CustomOverlay? = null
        ...
        try {
            for (cameraId in manager.cameraIdList) {
                ...
                if (orientation == Configuration.ORIENTATION_LANDSCAPE) {
                    ...
                    overlay!!.setAspectRatio(mPreviewSize!!.width, mPreviewSize!!.height)
                } else {
                    mTextureView!!.setAspectRatio(
                        mPreviewSize!!.height, mPreviewSize!!.width
                    )
                    overlay!!.setAspectRatio(mPreviewSize!!.height, mPreviewSize!!.width)
                }
